        ...
        <div className="flex flex-col lg:flex-row gap-4 md:gap-6">
          ...
          <div className="flex-1 space-y-3 sm:space-y-4">
            ...
            {formattedPosts.length === 0 ? (
              <div className="text-center py-8 sm:py-12 bg-white rounded-xl sm:rounded-2xl border">
                <p className="text-sm sm:text-base text-gray-600 mb-4">No posts yet. Be the first to share!</p>
                <Button
                  onClick={() => window.location.href = "/create"}
                  className="rounded-lg sm:rounded-xl bg-gradient-to-br from-yellow-400 to-orange-500 text-white hover:from-yellow-500 hover:to-orange-600 shadow-lg shadow-orange-500/30 text-sm sm:text-base"
                >
                  Create Post
                </Button>
              </div>
