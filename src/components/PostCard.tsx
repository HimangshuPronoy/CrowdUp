...
export default function PostCard({
  ...
  return (
    <div 
      ...
      className="rounded-xl sm:rounded-2xl border border-gray-200 bg-white p-3 sm:p-4 md:p-5 shadow-sm hover:shadow-md transition-all cursor-pointer"
    >
      <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Title */}
          <h3 className="text-sm sm:text-base font-semibold mb-1.5 sm:mb-2 text-gray-900 leading-snug">
            {title}
          </h3>

          {/* Description */}
          <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3 leading-relaxed line-clamp-2 sm:line-clamp-3">
            {description}
          </p>
          ...
          <div className="flex items-center justify-between pt-0.5 sm:pt-1">
            ...
            >
              ...
              <span className="text-xs sm:text-sm text-gray-600 truncate">{author}</span>
              <span className="text-xs sm:text-sm text-gray-400 hidden sm:inline">• {timestamp}</span>
            </button>
            ...
            <div className="flex items-center gap-0.5 sm:gap-1 flex-shrink-0">
              <Button 
                variant="ghost" 
                size="sm" 
                className="gap-1 sm:gap-1.5 h-7 sm:h-8 px-1.5 sm:px-2.5 text-gray-600 hover:bg-gray-100"
                onClick={(e) => {
                  e.stopPropagation();
                  handlePostClick();
                }}
              ...
              <Button 
                variant="ghost" 
                size="icon" 
                className="h-7 w-7 sm:h-8 sm:w-8 text-gray-600 hover:bg-gray-100"
                onClick={handleShare}
              >
